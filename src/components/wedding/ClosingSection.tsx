...
export default function ClosingSection() {
  ...
  return (
    ...
    >
      ...
      >
        <p className="font-serif text-xl sm:text-2xl text-white/90 leading-relaxed mb-8 drop-shadow-lg">
          Cảm Ơn Bạn
          <br />
          Đã Đến Chung Vui
          <br />
        ...
        <p className="font-sans text-xs tracking-[0.25em] text-white/50 mt-4 drop-shadow-lg">
